...
var builtinPermissions = []permissionSeed{
	...
	{Code: "dictionary:update", Name: "Update dictionaries", Description: "Update system dictionaries and items"},
	{Code: "dictionary:delete", Name: "Delete dictionaries", Description: "Delete system dictionaries and items"},
	{Code: "operation:read", Name: "Read operation records", Description: "Read HTTP operation records"},
	{Code: "operation:delete", Name: "Delete operation records", Description: "Delete HTTP operation records"},
	{Code: "parameter:read", Name: "Read parameters", Description: "Read system parameters"},
