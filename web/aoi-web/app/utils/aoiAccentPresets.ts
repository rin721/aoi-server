...
export type AoiAccentPresetTextResolver = (key: string, fallback: string) => string
...
export const AOI_ACCENT_PRESETS: AoiAccentPresetOption[] = [
  {
    ...
    label: "葵花橙",
    labelKey: "accentPresets.sunflowerOrange.label",
    subtitle: "Sunflower Orange",
    subtitleKey: "accentPresets.sunflowerOrange.subtitle",
    accent60: "#ff7d52",
    accent50: "#ff9471",
    accent40: "#ffb49b",
    accent20: "#ffe0d5",
  ...
  },
  {
    value: "cocoa-pink",
    label: "心爱粉",
    labelKey: "accentPresets.cocoaPink.label",
    subtitle: "Cocoa Rose",
    subtitleKey: "accentPresets.cocoaPink.subtitle",
    accent60: "#d94f8f",
    accent50: "#f2709c",
    accent40: "#f69bb9",
    accent20: "#ffd6e5",
  ...
  },
  {
    value: "chino-blue",
    label: "智乃蓝",
    labelKey: "accentPresets.chinoBlue.label",
    subtitle: "Chino Clear",
    subtitleKey: "accentPresets.chinoBlue.subtitle",
    accent60: "#0f9fb7",
    accent50: "#22b8cf",
    accent40: "#5ed3df",
    accent20: "#c9f3f7",
  ...
  },
  {
    value: "rize-purple",
    label: "理世紫",
    labelKey: "accentPresets.rizePurple.label",
    subtitle: "Rize Violet",
    subtitleKey: "accentPresets.rizePurple.subtitle",
    accent60: "#6f62d9",
    accent50: "#897df1",
    accent40: "#aaa2f7",
    accent20: "#ddd9ff",
  ...
  },
  {
    value: "chiya-green",
    label: "千夜绿",
    labelKey: "accentPresets.chiyaGreen.label",
    subtitle: "Chiya Matcha",
    subtitleKey: "accentPresets.chiyaGreen.subtitle",
    accent60: "#3f9c75",
    accent50: "#5fc795",
    accent40: "#8eddb8",
    accent20: "#d6f3e5",
  ...
  },
  {
    value: "syaro-yellow",
    label: "纱路黄",
    labelKey: "accentPresets.syaroYellow.label",
    subtitle: "Syaro Honey",
    subtitleKey: "accentPresets.syaroYellow.subtitle",
    accent60: "#c98b14",
    accent50: "#f7b955",
    accent40: "#ffd47f",
    accent20: "#ffedc7",
  ...
  },
  {
    value: "maya-cyan",
    label: "麻耶青",
    labelKey: "accentPresets.mayaCyan.label",
    subtitle: "Maya Aqua",
    subtitleKey: "accentPresets.mayaCyan.subtitle",
    accent60: "#0e89a6",
    accent50: "#2eb6d6",
    accent40: "#72d8ea",
    accent20: "#d2f4fb",
  ...
  },
  {
    value: "megumi-red",
    label: "小惠红",
    labelKey: "accentPresets.megumiRed.label",
    subtitle: "Megu Berry",
    subtitleKey: "accentPresets.megumiRed.subtitle",
    accent60: "#d04758",
    accent50: "#f36f7e",
    accent40: "#f89aa5",
    accent20: "#ffd8de",
...
export function createAoiAccentPresetCardOptions(
  cards: AoiAccentPresetCards = {},
  resolveText?: AoiAccentPresetTextResolver
  ...
  return AOI_ACCENT_PRESETS.map((preset) => {
    ...
    const presetLabel = resolveText?.(preset.labelKey, preset.label) || preset.label
    const presetSubtitle = resolveText?.(preset.subtitleKey, preset.subtitle) || preset.subtitle
    ...
    return {
      ...
      cardSubtitle: card.subtitle || presetSubtitle,
      cardTitle: card.title || presetLabel
    }
  })
}
