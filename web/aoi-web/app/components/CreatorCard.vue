  ...
  >
    ...
    <template v-if="showActions" #actions>
      <AoiButton
        ...
        :aria-label="isFollowing ? t('creator.actions.unfollowAria', { name: creator.displayName }) : t('creator.actions.followAria', { name: creator.displayName })"
        :disabled="!following.hydrated"
        @click="following.toggleCreator(creator)"
      >
        {{ isFollowing ? t("creator.actions.following") : t("creator.actions.follow") }}
      </AoiButton>
    </template>
  </AoiInfoCard>
</template>
