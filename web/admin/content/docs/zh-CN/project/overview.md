---
title: 项目概览
description: admin 是前端优先的 Nuxt 4 视频社区应用，当前以本地 mock API 和浏览器状态为主。
order: 10
category: project
navigation:
...
`admin` 是一个 Nuxt 4 前端优先应用，面向视频社区、创作者主页、投稿、播放、弹幕和设置体验。当前阶段以本地 mock API 与浏览器本地状态为主，同时保留面向未来 Go 后端的 DTO 契约。
