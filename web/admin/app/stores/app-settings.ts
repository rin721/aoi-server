...
export const useAppSettingsStore = defineStore("app-settings", () => {
  ...
  async function restoreBackgroundObjectUrl() {
    ...
    try {
      ...
      backgroundFileName.value = ""
      backgroundFileSize.value = 0
      backgroundError.value = "settings.appearancePage.backgroundErrors.read"
    }
  }
  ...
  async function setBackgroundFile(file: File) {
    ...
    if (!AOI_BACKGROUND_TYPES.includes(file.type)) {
      backgroundError.value = "settings.appearancePage.backgroundErrors.type"
      return false
    }

    if (file.size > AOI_BACKGROUND_MAX_BYTES) {
      backgroundError.value = "settings.appearancePage.backgroundErrors.size"
      return false
    }
    ...
    try {
      ...
      backgroundError.value = "settings.appearancePage.backgroundErrors.save"
      return false
    }
  }
  ...
  async function clearBackground() {
    ...
    try {
      ...
      backgroundError.value = "settings.appearancePage.backgroundErrors.clear"
    }
