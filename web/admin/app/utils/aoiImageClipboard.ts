...
export const aoiDefaultImageAspectRatios: AoiImageClipboardAspectOption[] = [
  { label: "Free", labelKey: "imageTools.freeRatio", value: "free", icon: "move", ratio: Number.NaN },
...
export async function copyAoiImageBlobToClipboard(blob: Blob) {
  if (!navigator.clipboard || typeof ClipboardItem === "undefined") {
    throw new Error("imageTools.clipboardUnsupported")
  }
  ...
  try {
    ...
    throw new Error("imageTools.clipboardPermission")
  }
}
